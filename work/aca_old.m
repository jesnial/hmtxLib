function [U,VT] = aca(kernelrow,kernelcol,M,N,eps)

% USE:
% [U,VT] = aca(kernelrow,kernelcol,M,N,eps)
%
% INPUTS:
% 'kernelrow': handle to function for calculating one row of the matrix 
% 'kernelcol': handle to function for calculating one column of the matrix 
